...
export default handleActions({
    [LOGIN]: (state) => {
        ...
        return Object.assign({}, state, { error: null, isRunning: true });
    },
    ...
    [LOGIN_SUCCESS]: (state, action: Action) => {
        ...
        return Object.assign({}, state, { isRunning: false, error: null, data: { username: action.payload.username, token: action.payload.token } });
    },
    [LOGOUT]: () => {
        return initialState;
    }
